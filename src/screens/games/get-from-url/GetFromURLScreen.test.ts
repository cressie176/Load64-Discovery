    ...
    describe("cover-art flow", () => {
      it("returns standard breadcrumb", () => {
        eq(
          ...
          "Bubble Bobble > Media > Cover Art > From URL",
        );
      });
      ...
      it("returns import breadcrumb", () => {
        eq(
          ...
          "Import Games > Bubble Bobble > Media > Cover Art > From URL",
        );
      });
      ...
      it("uses importTitle when provided", () => {
        eq(
          ...
          "Import Games > BB disc1 > Media > Cover Art > From URL",
        );
      });
    });
    ...
    describe("screenshots flow", () => {
      it("returns standard breadcrumb", () => {
        eq(
          ...
          "Out Run > Media > Screenshots > From URL",
        );
      });
      ...
      it("returns import breadcrumb", () => {
        eq(
          ...
          "Import Games > Out Run disc1 > Media > Screenshots > From URL",
        );
      });
    });
