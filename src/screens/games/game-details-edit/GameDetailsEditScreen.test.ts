  ...
  describe("deriveScreenTitle", () => {
    ...
    it("returns import breadcrumb before fetch", () => {
      assert.equal(
        ...
        "Import Games > Bubble Bobble > Game Details",
      );
    });
    ...
    it("uses importTitle when provided", () => {
      assert.equal(
        ...
        "Import Games > BB disc1 > Game Details",
      );
    });
    ...
    it("appends fetch source in import mode after fetch", () => {
      assert.equal(
        ...
        "Import Games > Bubble Bobble > Game Details > GameBase64: 243",
      );
    });

    it("does not append fetch source in simple mode", () => {
      assert.equal(
